...
enum STEREO_CAMERA_DETECT_MODE_TYPE
{
	STEREO_CAMERA_DETECT_CLOSE_MODE = 0,
	STEREO_CAMERA_DETECT_OPEN_MODE = 1,
};

enum STEREO_CAMERA_TRACK_MODE_TYPE
{
	STEREO_CAMERA_TRACK_CLOSE_MODE = 0,
	STEREO_CAMERA_TRACK_OPEN_MODE = 1,
};
